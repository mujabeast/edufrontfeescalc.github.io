...
document.addEventListener("DOMContentLoaded", function() {
    ...
    if (adjustmentsContainer && addAdjustmentButton) {
        console.log("Elements found, adding event listener.");
        addAdjustmentButton.addEventListener('click', function() {
            console.log("Add Adjustment button clicked.");
            ...
            console.log("Adjustment inputs added to the container.");
        });
    } else {
        console.error("Elements not found: Check your HTML for IDs 'adjustmentsContainer' and 'addAdjustment'.");
    }
});
